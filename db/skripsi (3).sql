...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Mar 2022 pada 07.04
...
CREATE TABLE `detail_penanganan` (
  `id_detail_penaganan` int(11) NOT NULL,
  `id_penanganan` varchar(5) NOT NULL,
...
INSERT INTO `detail_penanganan` (`id_detail_penaganan`, `id_penanganan`, `id_pertanyaan`) VALUES
(9, 'EvkVi', 'sU797'),
(10, 'EvkVi', 'BcmeX');
...
INSERT INTO `detail_riwayat` (`id_detail_riwayat`, `id_riwayat`, `id_gejala`) VALUES
(1, '4OMWo', 'G1'),
(2, '4OMWo', 'G2'),
(3, 'A7FXP', 'G23'),
(4, 'A7FXP', 'G24'),
...
INSERT INTO `hasil` (`id_hasil`, `id_riwayat`, `id_hama_penyakit`, `persentase`) VALUES
(1, 'umE0S', 'H1', 73.68),
(2, 'umE0S', 'H2', 41.67),
(3, 'MB5Ej', 'H2', 100),
(4, 'MB5Ej', 'H3', 43.75),
...
INSERT INTO `penanganan` (`id_penanganan`, `id_riwayat`, `tanggal_mulai`, `tanggal_selesai`, `status`) VALUES
('18', 'umE0S', '2022-02-21', '2022-02-21', 3),
('20', 'MB5Ej', '2022-02-23', '2022-02-23', 3),
('EvkVi', 'umE0S', '2022-03-14', '2022-03-14', 2),
('r0Tlg', 'chyEg', '2022-03-14', '2022-03-14', 1);
...
CREATE TABLE `pertanyaan` (
  ...
  `kondisi_tanaman` int(1) NOT NULL COMMENT '1 = mati, 2 = memburuk, 3 = membaik, 4 = sembuh',
  `solusi` text NOT NULL,
...
INSERT INTO `pertanyaan` (`id_pertanyaan`, `id_hama_penyakit`, `pertanyaan`, `kondisi_tanaman`, `solusi`, `created_at`) VALUES
('BcmeX', 'H1', 'pertanyaan memburuk 2', 2, 'Solusi pertanyaan memburuk 2', '2022-03-14 08:46:07'),
('sU797', 'H1', 'pertanyaan memburuk 1', 2, 'Solusi pertanyaan memburuk 1', '2022-03-14 08:45:41');
...
('4OMWo', 4, '2022-01-17 19:15:33', 2),
('A7FXP', 4, '2022-01-17 19:29:30', 2),
('chyEg', 4, '2022-02-24 09:58:50', 1),
('MB5Ej', 4, '2022-02-20 19:33:29', 1),
('RUib7', 4, '2022-02-09 09:12:35', 2),
('umE0S', 4, '2022-02-13 17:10:16', 1);
...
ALTER TABLE `detail_penanganan`
  ADD PRIMARY KEY (`id_detail_penaganan`);
...
--
-- AUTO_INCREMENT untuk tabel `detail_penanganan`
--
ALTER TABLE `detail_penanganan`
  MODIFY `id_detail_penaganan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `detail_riwayat`
--
ALTER TABLE `detail_riwayat`
  MODIFY `id_detail_riwayat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
